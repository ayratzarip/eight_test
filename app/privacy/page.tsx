    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-2xl p-8">
          <p></p>
          <h4 className="mbr-section-subtitle mbr-fonts-style mb-4 display-5" style={{ textAlign: 'center' }}>
            <strong>Политика в отношении обработки персональных данных</strong>
          </h4>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>1. Общие положения</p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
            1.1. Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ &laquo;О персональных данных&raquo; (далее &mdash; Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые веб-приложением EightFaces: Soft Skills Engine (далее &mdash; Оператор).<br />
            ...
            1.3. Настоящая политика Оператора в отношении обработки персональных данных (далее &mdash; Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://eightfaces.ru">https://eightfaces.ru</a>.
          </p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />2. Основные понятия, используемые в Политике</p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
            ...
            2.3. Веб-сайт &mdash; совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://eightfaces.ru.<br />
            ...
            2.8. Персональные данные &mdash; любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://eightfaces.ru.<br />
            ...
            2.10. Пользователь &mdash; любой посетитель веб-сайта https://eightfaces.ru.<br />
          ...
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />3. Основные права и обязанности Оператора</p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
          ...
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />4. Основные права и обязанности субъектов персональных данных</p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
          ...
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />5. Принципы обработки персональных данных</p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
          ...
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />6. Цели обработки персональных данных</p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
            6.1. Цель обработки предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте<br />
            Персональные данные:<br />
            &mdash; фамилия, имя, отчество;<br />
            &mdash; электронный адрес;<br />
            &mdash; номера телефонов;<br />
            6.2. Правовые основания:<br />
            &mdash; Федеральный закон &laquo;Об информации, информационных технологиях и о защите информации&raquo; от 27.07.2006 N 149-ФЗ.<br />
            6.3. Виды обработки персональных данных:<br />
            &mdash; Отправка информационных писем на адрес электронной почты.
          </p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />7. Условия обработки персональных данных</p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
          ...
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />8. Порядок сбора, хранения, передачи и других видов обработки персональных данных</p>
          <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
            ...
            8.4. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора info@eightfaces.ru с пометкой &laquo;Актуализация персональных данных&raquo;.<br />
            8.5. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством.<br />Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора info@eightfaces.ru с пометкой &laquo;Отзыв согласия на обработку персональных данных&raquo;.<br />
            ...
            <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />9. Перечень действий, производимых Оператором с полученными персональными данными
            </p>
            <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>
            ...
            <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />10. Трансграничная передача персональных данных</p>
            <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>10.1. Оператор до начала осуществления деятельности по трансграничной передаче персональных данных обязан уведомить уполномоченный орган по защите прав субъектов персональных данных о своем намерении осуществлять трансграничную передачу персональных данных (такое уведомление направляется отдельно от уведомления о намерении осуществлять обработку персональных данных).<br />10.2. Оператор до подачи вышеуказанного уведомления, обязан получить от органов власти иностранного государства, иностранных физических лиц, иностранных юридических лиц, которым планируется трансграничная передача персональных данных, соответствующие сведения.</p>
            <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />11. Конфиденциальность персональных данных</p>
            <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>Оператор и иные лица, получившие доступ к персональным данным, обязаны не раскрывать третьим лицам и не распространять персональные данные без согласия субъекта персональных данных, если иное не предусмотрено федеральным законом.</p>
            <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}><br />12. Заключительные положения</p>
            <p className="mbr-text mbr-fonts-style display-4" style={{ textAlign: 'justify' }}>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты info@eightfaces.ru.<br />12.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика действует бессрочно до замены ее новой версией.<br />12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://eightfaces.ru/privacy.</p>
        </div>
      </div>
    </div>
  );
