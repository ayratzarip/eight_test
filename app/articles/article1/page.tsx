          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <div className="prose prose-lg max-w-4xl">
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify">
                ...
                . Так начинает книгу Филипп Зимбардо, которого считают главным
                авторитетом по застенчивости. Дальше он приводит цитаты из
                толковых словарей и предлагает нам самим понять, что это значит.
                И если нет чёткого определения, то каждый будет понимать это
                по-своему.
              </p>
              <p className="text-gray-600 text-lg mb-6 text-justify">
                ...
                . В МКБ-10 выделяли несколько видов расстройств личности,
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify">
                ...
                . РАС &ndash; это спектр расстройств от лёгких до тяжёлых.
              </p>
              <h3 className="font-bold mb-4">
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify">
                ...
                . Никто из окружающих не сможет заподозрить, что у них
                &laquo;нарушена обработка сенсорной информации&raquo;. Это ещё
                более размывает границу между &laquo;нормальными&raquo; и
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify">
                ...
                симптоматики между СТР и РАС, с частотой от 13% до 50%{" "}
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify">
                ...
                . Это похоже на то, как растут мышцы у бодибилдера: чем больше
                качается, тем больше мышцы. Так же чем больше человек
                тревожится, тем больше становится миндалевидное тело.
                Миндалевидное тело у разных людей изменяется по-разному.
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify">
                ...
                тренировки присутствия в настоящем моменте{" "}
