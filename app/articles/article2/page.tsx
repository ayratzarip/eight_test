        ...
        <div className="container mx-auto px-4 py-8">
          <div className="bg-white rounded-xl shadow-2xl p-8 mb-8">
            ...
            <div className="prose prose-lg max-w-4xl">
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify ">
                Давайте три раза ответим на вопрос: почему я заболел
                коронавирусной инфекцией?
              </p>
              <p className="text-gray-600 text-lg mb-6 text-justify ">
                <strong>Детерминация или причинно-следственные связи.</strong> Я
                заболел, потому что в метро взялся рукой за поручень и потёр
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify ">
                <strong>Этиология</strong>. COVID-19 вызывается коронавирусом
                SARS-CoV-2.
              </p>
              <p className="text-gray-600 text-lg mb-6 text-justify ">
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify ">
                <strong>Патогенез</strong>. Мне стало плохо, потому что вирус
                попал в клетки, убил их, при распаде высвободились биополимерные
                молекулы, на них отреагировали соседние клетки и клетки крови,
                последние выбросили цитокины и хемокины, которые начали поражать
                здоровые клетки по всему организму.
              </p>
              <p className="text-gray-600 text-lg mb-6 text-justify ">
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify border-b">
                ...
                <br />
                <em>- Думаю не о том – проблемы с мыслями.</em>
                <br />
                <em>- Сильно тревожусь – проблемы с эмоциями.</em>
                <br />
                <em>- Не так выгляжу – проблемы с внешним видом.</em>
                <br />
                <em>
                  - Не знаю когда и что сказать – проблемы с содержанием речи.
                </em>
                <br />
                <em>
                  - Занимаю неуверенную позу, плохо двигаюсь – проблемы с
                  пантомимикой.
                </em>
                <br />
                <em>
                  - У меня что-то не так с выражением лица – проблемы с мимикой.
                </em>
                <br />
                <em>- Что-то не так с голосом – проблемы с голосом</em>
              </p>
